...
namespace Blog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var blogDbContext = _context.Comments.Include(c => c.Article);
        ...
        public async Task<IActionResult> Create_id(int id, [Bind("Content,ArticleId")] Comment comment)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,Created,Updated,ArticleId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
                _context.Add(comment);
...
#pragma warning restore CS0162 // Code inaccessible détecté
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,Created,Updated,ArticleId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
